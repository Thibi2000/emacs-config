...
#+BEGIN_SRC emacs-lisp
  (setq thibi/org-sorted-files '(("/home/thibault/Downloads/films/todownload.org" . (t ?a))))
  (defun thibi/org-sort-files () 
    ...
    (message "Calling org-sort-files") 
    (if (assoc (buffer-file-name) thibi/org-sorted-files) 
	(save-excursion (goto-char 0) 
			(apply #'org-sort-entries (cdr (assoc (buffer-file-name)
